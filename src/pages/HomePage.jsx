  ...
  return (
    <section className="portfolio-teaser">
      <div className="portfolio-teaser__inner">
        <h2 className="portfolio-teaser__title">
          <span>NEJLÍP JE TO</span>
          <span style={{ marginLeft: '0.14em' }}>VIDĚT</span>
          <span style={{ marginLeft: '0.1em' }}>VE FEEDU.</span>
        </h2>
        <p className="portfolio-teaser__text text-body">
          Vybrané case studies a výstupy jsme dali do portfolia. Nahoře najdete hlavní
